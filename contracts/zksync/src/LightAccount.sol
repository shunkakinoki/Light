...
contract TwoUserMultisig is IAccount, IERC1271 {
  ...
  bytes4 public EIP1271_SUCCESS_RETURN_VALUE = 0x1626ba7e;
  ...
  function payForTransaction(Transaction calldata _transaction)
    external
    payable
    override
    onlyBootloader
  ...
  function prePaymaster(Transaction calldata _transaction)
    external
    payable
    override
    onlyBootloader
