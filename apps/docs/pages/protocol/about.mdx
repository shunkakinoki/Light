...
to act in beneficial of the trusted network, we aim to build a sustainable reputation system that lives forever on-chain.
...
We hope to establish an on-chain reputation system to incentivize actual contributions the blockchain.
Since everything can be financialized on the blockchain, it leads for a very unfriendly environment for new comers.
Through introducing non-financialized incentives and social status, we hope to start a new movement to support a billion people on web3.
