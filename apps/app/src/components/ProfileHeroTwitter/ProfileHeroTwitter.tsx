...
export const ProfileHeroTwitter: FC<ProfileHeroTwitterProps> = ({
  ...
  if (address === walletAddress && username === "") {
    return (
      <button
        className={clsx(
          "inline-flex cursor-pointer items-center overflow-hidden rounded-full border border-blue-500 py-1 px-6 text-sm text-blue-500 shadow-sm ring-offset-bg transition-all hover:bg-blue-300/10 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-4",
          s.transitionfix,
        )}
        onClick={() => {
