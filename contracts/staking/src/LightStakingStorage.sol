...
import "@lightdotso/staking/ILightStakingData.sol";
import "@lightdotso/staking/libs/Rebates.sol";
import "@lightdotso/staking/libs/Stakes.sol";

contract LightStakingStorageV1 is LightManager {
  ...
  mapping(address => ILightStakingData.Allocation) public allocations;

  // Space Allocations: spaceDeploymentID => tokens
  mapping(bytes32 => uint256) public spaceAllocations;
  ...
  mapping(address => ILightStakingData.DelegationPool) public delegationPools;
